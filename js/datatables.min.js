...
(function(c) {
    ...
    var o = c.fn.dataTable, j = function(b, a) {
        ...
        this.s.dt.settings()[0].responsive || (a && "string" === typeof a.details ? a.details = {
            ...
            type: "inline"
        }), this.c = c.extend(!0, {}, j.defaults, o.defaults.responsive, a), b.responsive = this,
        this._constructor());
    };
    c.extend(j.prototype, {
        ...
        _resize: function() {
            ...
            j && (this._redrawChildren(), c(a.table().node()).trigger("responsive-resize.dt", [ a, this.s.current ]),
    ...
    j.display = {
        ...
        childRowImmediate: function(b, a, d) {
            if (!a && b.child.isShown() || !b.responsive.hasHidden()) return b.child(!1), c(b.node()).removeClass("parent"),
            !1;
            b.child(d(), "child").show();
            c(b.node()).addClass("parent");
            return !0;
